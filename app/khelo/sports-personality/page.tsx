...
export const metadata: Metadata = {
  title: "Tum Kaunsa Sports Player Ho? — Sports Personality Quiz",
  description:
    "4 sawaal, 2 minute, aur pata chal jayega tum Weekend Warrior ho ya Daily Grinder. Malhar Sports ka Sports Personality Quiz try karo.",
